...
classdef BpodObject < handle
    ...
    methods
        function obj = BpodObject %Constructor            
            ...
            obj.Status.StatusEvents = uint8(zeros(0,18));
            obj.Status.FullStatePath = uint8([]);
            obj.Status.AllDataTrans = cell(0);
            obj.Status.NewStates = uint8(0);
            obj.Status.StateMachineSendTime = [];
            % Initialize paths
            obj.Path = struct;
